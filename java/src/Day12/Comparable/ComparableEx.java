...
public class ComparableEx {
	...
	public static void main(String[] args) {
		...
		bookList.add(new Book("잭1", "저자1", 10000));
		bookList.add(new Book("잭2", "저자2", 30000));
		bookList.add(new Book("잭3", "저자3", 50000));
		bookList.add(new Book("잭4", "저자4", 40000));
		bookList.add(new Book("잭5", "저자5", 20000));
